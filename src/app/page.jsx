...
import { pokemonsData,pokesearchgen } from "../components/Lasfunciones";
import FlechasArribaAbajo from "@/components/FlechasArribaAbajo";
import BotonBack from "@/components/BotonBack";
import Nuevodiseno from "@/components/Nuevodiseno";
...
export default function Home() {
  ...
  const [nuevodiseno, setnuevodiseno] = useState(true);
  ...
  return (
    <>
      {nuevodiseno ? (
        <Nuevodiseno pokesearchgen={pokesearchgen} />
      ) : (
